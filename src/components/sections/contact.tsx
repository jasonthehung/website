          ...
          <div className="flex flex-col md:flex-row items-center gap-6 mt-8">
            ...
            {/* Social Links */}
             <div className="flex gap-4">
               <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="p-4 rounded-full bg-white/5 border border-white/10 text-zinc-400 hover:text-white hover:bg-cyan-500/20 hover:border-cyan-500/50 hover:scale-110 transition-all shadow-lg flex items-center justify-center h-[60px] w-[60px]">
                  <Linkedin className="h-6 w-6" />
                  <span className="sr-only">LinkedIn</span>
               </a>
               <a href="https://github.com" target="_blank" rel="noreferrer" className="p-4 rounded-full bg-white/5 border border-white/10 text-zinc-400 hover:text-white hover:bg-cyan-500/20 hover:border-cyan-500/50 hover:scale-110 transition-all shadow-lg flex items-center justify-center h-[60px] w-[60px]">
